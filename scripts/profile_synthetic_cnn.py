#!/usr/bin/env python3
"""Profile compact-CNN complexity using generated zeros only."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Profile the compact CNN with generated zeros only. The resulting "
            "hardware-specific artifact is not a participant-performance result."
        )
    )
    parser.add_argument(
        "--config",
